...
//     let currentMin = now.minutes()
//     let currentSec = now.seconds()
//     let AngleHour =  'rotate(' + ((currentHour * 30) + (currentMin / 2)) + 'deg)'
//     console.log(AngleHour)
//     let AngleMin = 'rotate(' + (currentMin * 6) + 'deg)'
//     let AngleSec = 'rotate(' + (currentSec * 6) + 'deg)'
//     return(
//       <div >
//           <div id="watch">
...
//           </ul>
//           <div className="hours-hand" style={{transform: AngleHour}}/>
//           <div className="minutes-hand" style={{transform: AngleMin}}/>
//           <div className="seconds-hand" style={{transform: AngleSec}}/>
//         </div>
//       </div>
//     )
//   }
