      ...
      <div className="fixed w-60 ph3 pv3 pv4-ns ph4-m ph5-l top-100" style={{zIndex: "100", right: "40px", textAlign: "left"}}>
        ...
        {this.props.alertData.map(a => (
          <div className="center w-70" key={Math.random()*10000}>
            <div className={style} >
               <div role="alert">
                 <svg className={`dib h2 w2 ${a.color} mr2`} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={a.color} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d={a.icon}></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12" y2="17"></line></svg>
                {/*
